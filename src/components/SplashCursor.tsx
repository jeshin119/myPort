...
/**
 * SplashCursor — 무지개 유체(WebGL Fluid) 마우스 이펙트.
 *
 * Pavel Dobryakov의 WebGL-Fluid-Simulation(MIT)을 React 컴포넌트로 감싼
 * ReactBits `SplashCursor` 구현. 기본 설정값은 aaabadcode.com에서 추출한
 * 원본 값(DENSITY_DISSIPATION 0.5, VELOCITY_DISSIPATION 3, SPLAT_FORCE 6000 등)에 맞춤.
 *
 * 캔버스는 화면 전체를 덮는 투명 오버레이(prefers-reduced-motion 시 비활성).
 * 마우스 이동/클릭 지점에 매 프레임 랜덤 HSV 색으로 "splat"을 주입해
 * 무지개 물감이 번지는 효과를 낸다.
 */
